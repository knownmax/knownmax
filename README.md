...
I'm an AI engineer specializing in **Computer Vision** and **Natural Language Processing**. I design, build, and ship deep learning systems — from diffusion models and image translation networks to transformer-based NLP pipelines. My focus goes beyond training models: I care about failure analysis, robustness, and making AI work reliably in production.
...
| Domain | Focus Areas |
|--------|-------------|
| **Computer Vision** | Image classification · Object detection · Segmentation · Generative models (diffusion, GANs) · Image-to-image translation |
| **NLP** | Text classification · Sentiment analysis · LLM fine-tuning · Transformer architectures |
| **MLOps & Engineering** | Model evaluation & debugging · Training pipelines · Deployment · Reproducibility |
...
💬 **Ask me about** computer vision, generative models, NLP pipelines, or anything PyTorch.

*Let's connect and build something amazing together!*

[![GitHub](https://img.shields.io/badge/GitHub-knownmax-181717?style=for-the-badge&logo=github)](https://github.com/knownmax)
